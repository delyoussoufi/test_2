...
class TokenModel(db.Model, BaseModel):
    ...
    user_id = db.Column(db.String(16), db.ForeignKey(TableNames.T_USER + ".user_id"), name="user_id", unique=False, nullable=False)
    ...
    def find_by_user_id(cls, user_id):
        tokens = cls.find_by(get_first=False, user_id=user_id)
        if tokens:
            return tokens
